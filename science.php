...
<head>
    ...
    <title>Science Challenges</title>
...
<body class="pt-5">
    ...
    <div class="container mt-5">
        <h1 class="text-center">Science Challenges</h1>
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="card challenge-card p-3 shadow-lg">
                    ...
                    <a href="science_easy_quiz.html" class="btn btn-primary m-1 w-100">Start Challenge</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card challenge-card p-3 shadow-lg">
                    <h5>Chemistry Experiment</h5>
                    <p>Difficulty: Medium</p>
                    <span class="badge bg-warning text-dark">Earn 200 XP</span>
                    <a href="science_medium_quiz.html" class="btn btn-primary m-1 w-100">Start Challenge</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card challenge-card p-3 shadow-lg">
                    <h5>Biology Case Study</h5>
                    <p>Difficulty: Hard</p>
                    <span class="badge bg-warning text-dark">Earn 300 XP</span>
                    <a href="science_hard_quiz.html" class="btn btn-primary m-1 w-100">Start Challenge</a>
                </div>
            </div>
        </div>
